    ...
    <div className="storefront-container">
      <div className="storefront-header" >
        <div className="header-content" style={{display:'flex',justifyContent:'space-between',alignItems:'center',height:"35px"}}>
          <p style={{color:'white',fontSize:"1.2rem",fontFamily: "'Cormorant Garamond', serif",letterSpacing:"1px"}} className="store-name-left">{seller.storeName}</p>
      ...
      {filteredProducts.length === 0 ? (
        ...
        <div className="products-grid" style={{marginTop:"90px"}}>
          ...
          <section className="why-shop-section">
            <h2 className="why-shop-title">Why Buy from {seller.storeName}</h2>
