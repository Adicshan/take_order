...
router.post('/create', async (req, res) => {
  try {
    ...
    // Email sending is disabled due to deployment restrictions.
    // ...existing code...
    // If you want to enable email notifications, uncomment the code below and ensure SMTP is allowed on your host.
    // ...existing code...
